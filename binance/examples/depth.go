...
import (
	...
	"github.com/robertkohut/go-binance/binance"
...
// State message received from websocket
type State struct {
...
// ProcessBids Processes all incoming bids
...
// ProcessAsks Processes all incoming asks
...
// Maintainer hands off incoming messages to processing functions
