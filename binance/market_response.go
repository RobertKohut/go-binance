...
// OrderBook Result from: GET /api/v1/depth
...
// ChangeStats Result from: GET /api/v1/ticker/24hr
...
// AggTrade Result from: GET /api/v1/aggTrade
...
// TickerPrice Result from: GET /api/v1/allPrices
type TickerPrice struct {
	Symbol string  `json:"symbol"`
	Price  float64 `json:"price,string"`
}

// BookTicker Result from: GET /api/v1/allBookTickers
...
// Kline Result from: GET /api/v1/klines
type Kline struct {
	OpenTime         int64
	Open             float64
	High             float64
...
// ExchangeInfo Result from: GET /api/v3/exchangeInfo
...
// SymbolInfo symbol result from: /api/v1/exchangeInfo
...
// SymbolFilter result from symbol filters: /api/v1/exchangeInfo
